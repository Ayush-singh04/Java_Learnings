...
public class Bit_manipulation {
    public static void main(String[] args) {
        ...
        int pos = 2; // Target bit position (0-based, rightmost is 0)
        int bitmask = 1 << pos; //( Always use 1 to create bitmask by the given position)
           ...
           try{ int operation =sc.nextInt(); //(1:set bit , 0:clear bit)
            ...
            if (operation==1) {
                  ...
                  System.out.println(newnumber); 
                    ...
                    bitmask= 1<<pos;
                    notbitmask = ~bitmask;
                    newnumber2= notbitmask & n; // clear bit
                   System.out.println(newnumber2);
               }
               else  {
